...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("QAI_2", "Meda", "Monday", "LUNCH", "004Baked Beans_3", "100", "799.20", "312.00", "66.00", "79.20", "34.08", "-", null, Category="QAI")]
...
#line hidden
        ...
        public virtual void VerifyNutritionWeeklyTotalsEqualsTheSumOfAllMealPeriodTotals(string environment, string menuCycle, string day, string[] exampleTags)
        {
            string[] @__tags = new string[] {
                    "TC38807"};
            if ((exampleTags != null))
