...
namespace MenuCycle.Tests.PageObjects.Planning.PlanningTabDays
{
    ...
    {
        public ItemLine(IWebElement parent)
        {
        ...
        public ItemLineModel GetDTO()
        {
            return new ItemLineModel
            {
        ...
        public void SetData(ItemLineModel dto)
        {
        ...
        public void VerifyData(ItemLineModel dto)
        {
