...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("QAI", "SE001", "Local User Testing", "TUE 10 JUL", new string[] {
                "QAI"}, Category="QAI")]
...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("QAI", "SE001", "Local User Testing", "TUE 10 JUL", "TUESDAY - 10 July 2018", new string[] {
                "QAI"}, Category="QAI")]
...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("QAI", "SE001", "Local User Testing", "WED 11 JUL", new string[] {
                "QAI"}, Category="QAI")]
...
#line hidden
        ...
        [NUnit.Framework.CategoryAttribute("Smoke")]
        [NUnit.Framework.TestCaseAttribute("QAI", "SE001", new string[] {
                "QAI"}, Category="QAI")]
...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("QAI", "SE001", "Local User Testing", "THUR 2 AUG", new string[] {
                "QAI"}, Category="QAI")]
        public virtual void SaveButtonIsClickedWithoutAnyChangesAppliedLocalUser(string environment, string location, string menuCycle, string day, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Save button is clicked without any changes applied (Local user)", @__tags);
#line 110
this.ScenarioSetup(scenarioInfo);
#line 111
    testRunner.Given(string.Format("Menu Cycle app is open on \"{0}\"", environment), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
