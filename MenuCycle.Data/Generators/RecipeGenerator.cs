...
{
    public class RecipeGenerator : IGenerator<Recipes>
    {
        private readonly Faker<Recipes> faker;
        public RecipeGenerator()
        {
            this.faker = new Faker<Recipes>()
        ...
        public Recipes Generate()
        {
            return this.faker.Generate();
        }

        public IList<Recipes> Generate(int count)
        {
            return this.faker.Generate(count);
        }

        public IList<Recipes> Generate(int count, long customerId)
        {
